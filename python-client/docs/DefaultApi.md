...
[**update_target_weight_percentage**](DefaultApi.md#update_target_weight_percentage) | **POST** /powerautomate/automations/direct/workflows/f970e9425e6148aabdbb6a316802e92e/triggers/manual/paths/invoke | Updates the target weight percentage for a mouse
...
# **update_target_weight_percentage**
> object update_target_weight_percentage(api_version=api_version, body=body)

Updates the target weight percentage for a mouse

Update the target weight percentage for a mouse
...
with allen_powerplatform_client.ApiClient(configuration) as api_client:
    ...
    api_instance = allen_powerplatform_client.DefaultApi(api_client)
    api_version = 56 # int |  (optional)
    body = allen_powerplatform_client.UpdateTargetWeightPercentageRequest() # UpdateTargetWeightPercentageRequest |  (optional)

    try:
        # Updates the target weight percentage for a mouse
        api_response = api_instance.update_target_weight_percentage(api_version=api_version, body=body)
        print("The response of DefaultApi->update_target_weight_percentage:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->update_target_weight_percentage: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **api_version** | **int**|  | [optional] 
 **body** | [**UpdateTargetWeightPercentageRequest**](UpdateTargetWeightPercentageRequest.md)|  | [optional] 
